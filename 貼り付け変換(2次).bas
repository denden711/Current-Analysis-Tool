    ...
    For Each file In folder.Files
        If Right(file.Name, 4) = ".csv" Then
            ...
            With ws
                ...
                .Range("A45").Value = "(|V_max|/|V_min|)/2-V_max"
                .Range("A46").Value = "(|I_max|/|I_min|)_1/2"
                .Range("A47").Value = "(|I_max|/|I_min|)_1/2-I_1_max"
                .Range("A48").Value = "(|I_max|/|I_min|)_2/2"
                .Range("A49").Value = "(|I_max|/|I_min|)_2/2-I_2_max"
                .Range("A51").Value = "Ic_1_max"
                .Range("A52").Value = "Ic_2_max"
                ...
                .Range("B44").Formula = "=(ABS(B34)+ABS(B35))/2"
                .Range("B45").Formula = "=B44-B34"
                .Range("B46").Formula = "=(ABS(B20)+ABS(B21))/2"
                .Range("B47").Formula = "=B20-B46"
                .Range("B48").Formula = "=(ABS(B22)+ABS(B23))/2"
                .Range("B49").Formula = "=B22-B48"
                .Range("B51").Formula = "=MAX(N:N)"
                .Range("B52").Formula = "=MAX(Z:Z)"
